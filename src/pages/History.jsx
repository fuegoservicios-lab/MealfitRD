...
// [P1-PLAN-LOTE-224 · 2026-09-24] Vuelve a tener uso: el detalle por bloque del
                        ...
                        >
                            ...
                            <div className={styles.modalBody}>
                                ...
                                {(() => {
                                    ...
                                    // [P1-PLAN-LOTE-224 · 2026-09-24] Título, cuerpo y botón vienen del servidor en
                                                        ...
                                                        <ul className={styles.actionBannerReasons}>
                                                            {_br.map((r) => {
                                                                const _wk = (typeof r.week_number === 'number')
                                                                    ...
                                                                    : t('Chunk');
                                                                // [P1-PLAN-LOTE-224] En el idioma del usuario; sin título,
