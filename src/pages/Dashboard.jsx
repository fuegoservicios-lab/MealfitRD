...
// ⚡ Bolt: Pre-compiled STOP_WORDS_REGEX to optimize execution time and reduce
// instantiation overhead in `normalizeNameAlt`
...
const Dashboard = () => {
    ...
    const buildDeltaShoppingList = useCallback((shoppingList, inventoryOverride = null) => {
        ...
        const normalizeNameAlt = (name) => {
            ...
            // ⚡ Bolt: Use pre-compiled regex to eliminate O(N) regex creations
