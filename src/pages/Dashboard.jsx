...
const STOP_WORDS_PATTERN = new RegExp('\\b(' + NAME_STOP_WORDS.join('|') + ')\\b', 'gi');
...
const DashboardInner = () => {
    ...
    const buildDeltaShoppingList = useCallback((shoppingList, inventoryOverride = null) => {
        ...
        const normalizeNameAlt = (name) => {
            ...
            // [P5-SPEED-DELTA-CONSTS-HOIST · 2026-06-01] STOP_WORDS_PATTERN precompilada
            // a module-scope (antes: array de Regex iterada por cada ítem). Al usar un patrón
            // consolidado con `|` se reduce la complejidad algorítmica de O(N) a O(1).
            n = n.replace(STOP_WORDS_PATTERN, '');
