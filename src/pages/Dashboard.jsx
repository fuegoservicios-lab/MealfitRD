...
// Pre-compiled regex for normalizeNameAlt stop words to avoid O(N) compilations during render
...
const Dashboard = () => {
    ...
    const buildDeltaShoppingList = useCallback((shoppingList, inventoryOverride = null) => {
        ...
        const normalizeNameAlt = (name) => {
            ...
            // ⚡ Bolt Optimization: Use pre-compiled STOP_WORDS_REGEX to avoid O(N) regex creations in loop
