...
// ⚡ Bolt Optimization: Pre-compile stop words into a single RegExp outside component
// This avoids O(N) regex instantiations and executions per ingredient normalization
...
const Dashboard = () => {
    ...
    const buildDeltaShoppingList = useCallback((shoppingList, inventoryOverride = null) => {
        ...
        const normalizeNameAlt = (name) => {
            ...
            // ⚡ Bolt Optimization: Using hoisted pre-compiled STOP_WORDS_REGEX for O(1) performance
