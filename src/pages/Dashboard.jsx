...
// ⚡ Bolt Optimization: Hoist STOP_WORDS_REGEX outside the component.
// Replaces O(M*N) regex instantiation per execution with O(1) compiled regex,
// lowering overhead and reducing garbage collection pressure.
...
const Dashboard = () => {
    ...
    const buildDeltaShoppingList = useCallback((shoppingList, inventoryOverride = null) => {
        ...
        const normalizeNameAlt = (name) => {
            ...
            // ⚡ Bolt Optimization: Use hoisted aggregated STOP_WORDS_REGEX instead of instantiating
            // a new RegExp inside a loop for each stop word.
