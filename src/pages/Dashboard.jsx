...
const STOP_WORD_REGEX = new RegExp('\\b(' + NAME_STOP_WORDS.join('|') + ')\\b', 'gi');
...
const DashboardInner = () => {
    ...
    const buildDeltaShoppingList = useCallback((shoppingList, inventoryOverride = null) => {
        ...
        const normalizeNameAlt = (name) => {
            ...
            // [BOLT-PERF-SINGLE-REGEX] Aggregated sequential string replacements against
            // the "stop words" array into a single pre-compiled RegExp object. This optimizes
            // execution time and reduces overhead from O(N) to O(1) matching.
            n = n.replace(STOP_WORD_REGEX, '');
