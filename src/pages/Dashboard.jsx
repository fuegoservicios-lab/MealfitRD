...
// ⚡ Bolt: Pre-compile static stop words into a single regex to avoid O(N) instantiations
// during iterative operations like buildDeltaShoppingList
...
const Dashboard = () => {
    ...
    const buildDeltaShoppingList = useCallback((shoppingList, inventoryOverride = null) => {
        ...
        const normalizeNameAlt = (name) => {
            ...
            // ⚡ Bolt: Using pre-compiled STOP_WORDS_REGEX for O(1) performance
