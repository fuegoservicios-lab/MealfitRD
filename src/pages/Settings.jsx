...
// [P1-PLAN-LOTE-223 · 2026-09-24] Interruptor y hora de cada recordatorio de comida (health_profile.avisos_por_comida).
...
// [P1-PLAN-LOTE-225 · 2026-09-24] La categoría de un recuerdo del coach. El extractor la escribe en `metadata.category`
                                ...
                                <div style={{ marginTop: '0.85rem', paddingTop: '0.85rem', borderTop: '1px solid var(--border)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                    {[
                                        ...
                                        <Fragment key={clave}>
                                            ...
                                            {/* [P1-PLAN-LOTE-223] Con los de comida encendidos: cada comida, su interruptor y su hora. Tras
