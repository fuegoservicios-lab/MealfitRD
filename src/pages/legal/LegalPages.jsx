...
export const Privacy = () => (
    <LegalLayout title="Política de Privacidad" lastUpdated="22 de Agosto, 2026">
        ...
        <p>Como motor generativo utilizamos <strong>modelos de IA de última generación de proveedores externos</strong>. Hoy son <strong>dos</strong>: <strong>Z.ai</strong> genera su plan y mueve la conversación con el coach; <strong>OpenAI</strong> realiza la revisión clínica de los planes de pago, actúa como respaldo cuando Z.ai no responde y <strong>procesa las fotos de comida que usted escanea</strong>. La identidad, versión y combinación específica de los modelos que orquestamos constituye información confidencial de Bioboros (secreto comercial) y <strong>puede cambiar sin previo aviso</strong> a medida que evaluamos y adoptamos mejores modelos, siempre manteniendo los mismos estándares de calidad y validación. Lo que <strong>no</strong> cambia sin avisarle es <em>quién</em> recibe sus datos: si añadiéramos o sustituyéramos un proveedor, actualizaremos esta política antes. Específicamente enviamos a los proveedores:</p>
        <ul>
        ...
        <p>Z.ai trata estos datos bajo sus <a href="https://docs.z.ai/legal-agreement/privacy-policy" target="_blank" rel="noopener noreferrer" className={styles.link}>Términos de Servicio y Política de Privacidad</a> (que declaran que no almacena el contenido que se le envía por la API); sus servidores están principalmente en <strong>Singapur</strong>. OpenAI trata estos datos bajo sus <a href="https://openai.com/policies/" target="_blank" rel="noopener noreferrer" className={styles.link}>políticas de uso de la API</a> (que excluyen el uso de los datos de la API para entrenar sus modelos); sus servidores están principalmente en <strong>Estados Unidos</strong>. En ambos casos el envío implica una transferencia internacional de datos. No anonimizamos los datos antes de enviarlos porque la personalización requiere su contexto específico; sin embargo, NUNCA enviamos su nombre completo, correo electrónico ni datos de pago.</p>
        ...
        <ul>
            ...
            <li><strong>Z.ai (JINGSHENG HENGXING TECHNOLOGY PTE. LTD., Singapur)</strong> — generación del plan y conversación con el coach (perfil de salud, preferencias y conversación).</li>
        ...
        <p>Dado que nuestros proveedores (Neon, Z.ai, OpenAI, ElevenLabs, PayPal, Sentry, PostHog, Oracle Cloud, Cohere y, si usted los usa, Google y Apple) operan globalmente, sus datos pueden procesarse fuera de República Dominicana — principalmente en Estados Unidos y, en el caso de <strong>Z.ai</strong>, en <strong>Singapur</strong> (ver Sección 4). Exigimos a estos proveedores marcos de protección reconocidos (Cláusulas Contractuales Estándar y/o equivalentes). Nunca enviamos a estos proveedores su nombre completo, correo electrónico ni datos de pago.</p>
...
export const DataProtection = () => (
    <LegalLayout title="Política de Protección de Datos" lastUpdated="22 de Agosto, 2026">
        ...
        <p>Para generar y revisar su plan, y para analizar las fotos que escanea, parte de su perfil se procesa en servidores de nuestros proveedores de inteligencia artificial — <strong>Z.ai</strong> (Singapur) y <strong>OpenAI</strong> (Estados Unidos). Esto constituye una transferencia internacional de datos. Nunca enviamos su nombre completo, correo ni datos de pago. El detalle está en la <strong>Política de Uso de Inteligencia Artificial</strong>.</p>
...
export const AIUse = () => (
    <LegalLayout title="Política de Uso de Inteligencia Artificial" lastUpdated="22 de Agosto, 2026">
        ...
        <p>Lo que sí divulgamos siempre es <strong>quién recibe tus datos</strong>. Hoy son dos proveedores: <strong>Z.ai</strong> genera tu plan y mueve la conversación con el coach; <strong>OpenAI</strong> hace la revisión clínica de los planes de pago, actúa como respaldo cuando Z.ai no responde y <strong>analiza las fotos que escaneas</strong>. Si añadiéramos o sustituyéramos un proveedor, actualizaremos esta política y la Política de Protección de Datos antes. Para producir tu plan les enviamos únicamente lo necesario:</p>
        <ul>
...
export const ResponsibleDisclosure = () => (
    <LegalLayout title="Política de Divulgación Responsable" lastUpdated="30 de Junio, 2026">
        ...
        <p><strong>Fuera de alcance:</strong> los sistemas de nuestros proveedores subcontratados (PayPal, Z.ai, Neon, Sentry, Oracle Cloud, entre otros) — repórtales directamente a ellos según sus propios programas. También quedan fuera los hallazgos sin impacto demostrable de seguridad, como:</p>
        <ul>
