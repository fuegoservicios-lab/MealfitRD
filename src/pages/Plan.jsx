...
// [P1-PLAN-LOTE-225 · 2026-09-24] La frase con que el servidor explica el 409 `plan_recently_created`
                ...
                if (_hasObservations) {
                    import('sonner').then(({ toast }) => {
                        if (generatedPlan?._critical_rejection) {
                            ...
                            // [P1-PLAN-LOTE-225] Sólo las observaciones legibles en el idioma activo: una que
                    ...
                    if (error.code === 'plan_recently_created') {
                        ...
                        import('sonner').then(({ toast }) => {
                            toast.info(t("Tu plan ya estaba listo"), {
                                // [P1-PLAN-LOTE-225] La frase del servidor, en el idioma del usuario.
...
const PreviewScreen = ({ oldPlan, newPlan, onAccept, onReject, onRegenerate }) => {
    ...
    // [P1-PLAN-LOTE-225 · 2026-09-24] Las observaciones del revisor legibles en el idioma activo: una que no se
                ...
                {showReviewWarningBanner && (
                    <div style={{ marginTop: '2rem', padding: '1.5rem', background: 'rgba(245, 158, 11, 0.12)', borderRadius: '1rem', border: '1px solid rgba(245, 158, 11, 0.4)' }}>
                        ...
                        <p style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.85)', marginBottom: '0.75rem', lineHeight: 1.5 }}>
                            {/* [P1-PLAN-LOTE-225] glosado como en el aviso (el servidor lo manda en español) */}
