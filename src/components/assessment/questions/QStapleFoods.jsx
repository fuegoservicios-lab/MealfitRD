...
export const QStapleFoods = ({ onManualAdvance }) => {
    ...
    const results = q.length >= 2
        ? masterList
            ...
            //
            // [P1-PLAN-LOTE-224 · 2026-09-24] Y en los otros tres: cada fila trae su nombre en los 5 idiomas
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                    {staples.map(name => (
                        <span key={name} style={{
                            ...
                            {/* [P1-PLAN-LOTE-224] Se GUARDA el canónico (SSOT del motor) y se PINTA en el idioma del usuario. */}
                            {PLAN_POLICY_FORM_UI && (
