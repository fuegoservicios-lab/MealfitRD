// [P3-AVATAR-PICKER · 2026-06-20 · P0-FE-CI-RED · 2026-09-04] Catálogo de avatares minimalistas
// estilo Anthropic: paleta cálida y sobria (clay/sage/slate/ámbar…) + una forma geométrica simple
// en tono crema sobre un disco de color. Cero dependencias; cada avatar es un SVG circular puro y
// determinista. Vive aparte del componente `MinimalAvatar` porque `react-refresh/only-export-
// components` no admite datos y componentes en el mismo fichero. `getAvatarById` no tenía ningún
// consumidor y salió.
