...
// [P1-PLAN-LOTE-224 · 2026-09-24] Por qué `/api/discount/validate` rechaza un código (routers/billing.py): frases
...
const PaymentModal = ({
    ...
    const handleApplyCoupon = useCallback(async () => {
        ...
        try {
            ...
            // [P1-PLAN-LOTE-224 · 2026-09-24] El mensaje en el idioma del usuario. Además, un 4xx/5xx trae `detail`
