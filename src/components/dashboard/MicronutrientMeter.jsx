...
// [P1-PLAN-LOTE-224] Nombres, notas, dosis y avisos que compone el backend en español, traducidos al pintar.
...
function AttentionCard({ e, adviceItem, onAsk }) {
    ...
    // [P1-PLAN-LOTE-224 · 2026-09-24] Los textos los compone el backend en español y se traducen AL PINTAR
...
//
// [P1-PLAN-LOTE-224] El NOMBRE del nutriente va traducido: no es identificador del motor, y la frase la LEE el
