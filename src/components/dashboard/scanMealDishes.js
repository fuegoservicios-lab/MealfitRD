// [P1-PLAN-LOTE-223 · 2026-09-24] La cuenta de cada plato del escáner de comida, sin React: lo que precarga la foto,
    ...
    const componentes = (Array.isArray(data?.items) ? data.items : [])
        ...
        .map((it, i) => {
            ...
            return {
                ...
                // [P1-PLAN-LOTE-224] El nombre traducido que manda el servidor PARA LEER; `name` sigue siendo el que se
