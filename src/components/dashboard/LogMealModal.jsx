...
// [P1-PLAN-LOTE-224] Las líneas que no estaban en la Nevera, en el idioma del usuario.
    ...
    const estimarMacros = async () => {
        ...
        try {
            const res = await fetchWithAuth('/api/diary/consumed/estimate-macros', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ text: customDraft.name, meal_type: mealType, locale: getLocale() }),  // [P1-PLAN-LOTE-224]
            });
