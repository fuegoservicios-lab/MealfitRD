...
// [P1-PLAN-LOTE-223] y VARIAS fotos: un plato por foto, hasta 4, como en el chat
...
// [P1-PLAN-LOTE-223] La cantidad de cada ingrediente: «− [campo] +», sin el 0 que no se dejaba borrar.
...
// [P1-PLAN-LOTE-224] Nombres de alimento y líneas de ingrediente en el idioma del usuario (para PINTAR).
...
// [P1-PLAN-LOTE-223] La cuenta de cada plato (lo derivado de los ingredientes, las correcciones a mano, lo que viaja
...
//
// [P1-PLAN-LOTE-223 · 2026-09-24] Reconstruido tras la captura de un tester de Android («no me deja quitar el 0 para
            ...
            <div className={styles.componentMain}>
                <div className={styles.componentTop}>
                    {/* El nombre del alimento es el del motor (P1-I18N-DASHBOARD) y viaja así al servidor; se PINTA en el
                        idioma del usuario [P1-PLAN-LOTE-224]. Es un <label> de la casilla: tocar el nombre marca o
                        desmarca. */}
        ...
        <>
            ...
            <section className={styles.section} aria-labelledby={`${ids}-cuanto`}>
                ...
                {/* [P1-PHOTO-DEDUCTS · 2026-08-07] Componentes detectados, confirmables uno a uno. Se pinta solo si la
                    ...
                    difíciles de desglosar es registrar las macros. [P1-PLAN-LOTE-223] Con desglose, cada fila mueve
...
const ScanMealModal = ({ isOpen, onClose, userId, initialDaysAgo = 0 }) => {
    ...
    // [P1-PLAN-LOTE-223] Los platos de este registro, en el orden en que llegaron las fotos. Cada uno:
    ...
    // [P1-PLAN-LOTE-223] El interruptor de la Nevera, encendido como siempre: lo marcado se descuenta.
    ...
    const analizar = useCallback(async (id, file) => {
        ...
        try {
            ...
            // [P1-PLAN-LOTE-224] El nombre del plato y el de sus ingredientes vuelven en el idioma de esta pantalla.
            ...
            if (!res.ok || !data?.success) {
                // [P1-PLAN-LOTE-223] Cada foto dice lo suyo, con el copy del chat para los mismos códigos.
    ...
    // [P1-PLAN-LOTE-223] El visor se cierra al disparar: el análisis sigue en la tarjeta del plato, y mientras tanto se
    ...
    const registrar = useCallback(async () => {
        ...
        // [P1-PLAN-LOTE-223] Con la Nevera apagada nunca se pide la resta; encendida, lo decide el interruptor.
    ...
    const renderUnSolo = (p) => (
        <>
            <div className={`${styles.previewWrap} ${p.estado !== 'analizando' ? styles.previewCompact : ''}`}>
                ...
                {/* [P1-PLAN-LOTE-223] «Volver a escanear» vive sobre la foto que cambia, no en el pie: junto a
    ...
    return (
            ...
            >
                ...
                {platos.length === 0 && (
                    <>
                        ...
                        {/* [P1-PLAN-LOTE-223] Que se sepa que se puede: como en el chat, varias fotos a la vez. */}
                    ...
                    <div className={styles.reviewWrap}>
                        ...
                        {enRevision && (
                            <>
                                ...
                                {/* [P1-PLAN-LOTE-223] El mismo interruptor que el componedor. Solo con la Nevera en uso
        ...
        {/* [P1-SCANNER-SHARED · 2026-08-10] El mismo visor del escáner de la Nevera. [P1-PLAN-LOTE-223] Se cierra al
