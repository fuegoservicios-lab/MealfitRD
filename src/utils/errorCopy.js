...
/**
 * [P1-PLAN-LOTE-224 · 2026-09-24] El `message`/`detail` en prosa de un endpoint que NO emite código (la Nevera, los
...
export function mensajeDelServidor(texto, conocidas, fallback, t, locale = getLocale()) {
    ...
    console.error('[P1-PLAN-LOTE-224] mensaje del servidor sin traducción:', s);
    return fallback;
}
