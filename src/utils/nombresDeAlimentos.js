// [P1-PLAN-LOTE-224 · 2026-09-24] El nombre de un alimento del catálogo en el idioma del usuario.
//
...
//
// Desde el lote 224, cada fila de /api/catalog trae `names = {en-US, pt-BR, fr-FR, it-IT}` (backend
