...
// [P1-PLAN-LOTE-224] El nombre que se pinta y las formas de buscar, en los 5 idiomas.
...
export function searchFoods(query, foods, dishes, max = 12) {
    ...
    for (const f of foods || []) {
        // [P1-PLAN-LOTE-224 · 2026-09-24] El nombre en el idioma del usuario es el PROPIO: rango limpio. El canónico
