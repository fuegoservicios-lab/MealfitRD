...
export const buildGlossIndex = (masterList) => {
    ...
    for (const m of masterList) {
        ...
        // [P1-PLAN-LOTE-225 · 2026-09-24] Y el nombre en cada idioma, la misma forma que publica `pantryCache`.
...
export const glossShoppingItemName = (
    ...
    // [P1-PLAN-LOTE-225 · 2026-09-24] El gloss en el IDIOMA DEL USUARIO. Hasta este lote era inglés para cualquier
