...
// [P1-PLAN-LOTE-224] `names` = {locale: nombre}; sólo cadenas no vacías. null si no queda ninguna.
...
const _publicarIndiceDelGloss = (rows, ttlMs) => {
    try {
        ...
        for (const m of rows) {
            ...
            // [P1-PLAN-LOTE-224 · 2026-09-24] Y el nombre en cada idioma (`names`), para que la Nevera, el escáner y la
 ...
 * La forma string v1 sigue aceptada, y la de objeto sin `names` (publicada antes del lote 224) también: esas
 ...
 */
// [P1-PLAN-LOTE-224 · 2026-09-24] El índice se lee en cada línea que se pinta (Nevera, escáner, lista): parsear el
