// [P1-PLAN-LOTE-224 · 2026-09-24] El panel de micronutrientes, en el idioma del usuario.
//
...
// declara (`i18nKey`) y que `test_p1_plan_lote_224.py` compara con `micronutrients.py` y `micros_seguros.py`: si el
