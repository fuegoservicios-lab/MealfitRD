// [P1-PLAN-LOTE-224 · 2026-09-24] El escáner de comida, reconstruido.
//
...
// Lo que manda el servidor tras el lote 224: cada componente con su parte, que suma exactamente el total.
const ESPAGUETIS = {
...
describe('lote 224 · leer y mover una cantidad', () => {
...
describe('lote 224 · QuantityStepper', () => {
    const pintar = (props = {}) => {
...
describe('lote 224 · la cuenta de un plato (scanMealDishes)', () => {
...
describe('lote 224 · fuente y catálogos', () => {
