...
vi.mock('../utils/nativeChatImagePicker', () => ({
    ...
    // [P1-PLAN-LOTE-223] el de comida elige VARIAS fotos (un plato por foto)
...
// [P1-PLAN-LOTE-223] Cada escáner con SU selector: el de comida elige varias fotos (un plato por foto), el de la
