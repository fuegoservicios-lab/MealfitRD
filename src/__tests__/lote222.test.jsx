...
describe('lote 222 · el panel pinta lo que dice el servidor', () => {
    beforeEach(() => {
        vi.clearAllMocks();
...
describe('lote 222 · lo que se guarda', () => {
    beforeEach(() => {
        vi.clearAllMocks();
        comidasDelServidor = COMIDAS_NORMALES;
        fetchWithAuth.mockImplementation(async (url) => {
...
describe('lote 222 · Configuración lo pinta donde toca', () => {
