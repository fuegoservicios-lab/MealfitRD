// [P1-PLAN-LOTE-213 · 2026-09-24] Cada recordatorio de comida, con su interruptor y su hora.
//
...
describe('lote 213 · el panel pinta lo que dice el servidor', () => {
    beforeEach(() => {
        vi.clearAllMocks();
...
describe('lote 213 · lo que se guarda', () => {
    beforeEach(() => {
        vi.clearAllMocks();
        comidasDelServidor = COMIDAS_NORMALES;
        fetchWithAuth.mockImplementation(async (url) => {
...
describe('lote 213 · Configuración lo pinta donde toca', () => {
