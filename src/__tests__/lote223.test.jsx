// [P1-PLAN-LOTE-223 · 2026-09-24] Cada recordatorio de comida, con su interruptor y su hora.
//
...
describe('lote 223 · el panel pinta lo que dice el servidor', () => {
    beforeEach(() => {
        vi.clearAllMocks();
...
describe('lote 223 · lo que se guarda', () => {
    beforeEach(() => {
        vi.clearAllMocks();
        comidasDelServidor = COMIDAS_NORMALES;
        fetchWithAuth.mockImplementation(async (url) => {
...
describe('lote 223 · Configuración lo pinta donde toca', () => {
